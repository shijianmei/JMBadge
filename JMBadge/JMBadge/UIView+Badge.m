...
- (void)showBadge
{
    [self showBadgeWithStyle:JMBadgeStyleRedDot value:0 animationType:JMBadgeAnimTypeNone];
}
 ...
 */
- (void)showBadgeWithStyle:(JMBadgeStyle)style value:(NSInteger)value animationType:(JMBadgeAnimType)aniType
{
    self.aniType = aniType;
    switch (style) {
        case JMBadgeStyleRedDot:
            [self showRedDotBadge];
            break;
        case JMBadgeStyleNumber:
            [self showNumberBadgeWithValue:value];
            break;
        case JMBadgeStyleNew:
            [self showNewBadge];
            break;
        default:
            break;
    }
    if (aniType != JMBadgeAnimTypeNone) {
        [self beginAnimation];
    }
}

- (void)showNumberBadgeWithValue:(NSInteger)value animationType:(JMBadgeAnimType)aniType {
    self.aniType = aniType;
    [self showNumberBadgeWithValue:value];
...
- (void)showRedDotBadge
{
    ...
    if (self.badge.tag != JMBadgeStyleRedDot) {
        self.badge.text = @"";
        self.badge.tag = JMBadgeStyleRedDot;
...
- (void)showNewBadge
{
    ...
    if (self.badge.tag != JMBadgeStyleNew) {
        self.badge.text = @"new";
        self.badge.tag = JMBadgeStyleNew;
...
- (void)showNumberBadgeWithValue:(NSInteger)value
{
    ...
    self.badge.tag = JMBadgeStyleNumber;
...
- (void)badgeInit
{
    ...
    if (nil == self.badge) {
        ...
        self.badge.text = @"";
        self.badge.tag = JMBadgeStyleRedDot;//red dot by default
        self.badge.layer.cornerRadius = CGRectGetWidth(self.badge.frame) / 2;
